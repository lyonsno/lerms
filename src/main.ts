...
function drawReceipt(report: HandSurfaceReport, width: number, height: number): void {
  ...
  const lines = [
    ...
    `projection mirrorX ${report.surfaceFrame.mesh.projection.mirrorX} mirrorZ ${report.surfaceFrame.mesh.projection.mirrorZ} zParallax ${report.surfaceFrame.mesh.projection.viewAxisProjection === 'mirrored_z_parallax'} postX ${report.surfaceFrame.mesh.projection.postProjectionFlipX}`,
