...
assert(adapterFrame.terrain.heightRange === terrainBuffer.heightRange, 'Hill adapter preserves the source-owned height range');
...
assert(adapterFrame.channels.metricLayout.includes('wetness'), 'Hill adapter names the Hill wetness channel');
assert(adapterFrame.channels.metricLayout.includes('routePressure'), 'Hill adapter names route pressure');
assert(adapterFrame.channels.metricLayout.includes('surfaceVelocityY'), 'Hill adapter names support velocity');
assert(adapterFrame.channels.signedTerrainEvidenceChannels.includes('topologyDeformation'), 'Hill adapter identifies signed deformation as producer evidence');
assert(adapterFrame.channels.signedTerrainEvidenceChannels.includes('topologyVelocity'), 'Hill adapter identifies signed velocity as producer evidence');
assert(adapterFrame.channels.signedTerrainEvidenceChannels.includes('topologyForce'), 'Hill adapter identifies signed force as producer evidence');
assert(adapterFrame.channels.signedTerrainEvidenceChannels.includes('hillSwellMembership'), 'Hill adapter identifies swell membership as producer evidence');
assert(adapterFrame.channels.signedTerrainEvidenceChannels.includes('hillSlumpMembership'), 'Hill adapter identifies slump membership as producer evidence');
