...
assert.equal(offer.summary.frameCount, 6);
assert.equal(offer.summary.actorCount, 6);
assert.equal(offer.summary.possessionEventCount, 3);
assert.ok(offer.fields.some((field) => field.label === 'duration ms' && field.value === 3300));
...
assert.equal(offer.payloadReport.payload.summary.frameCount, 6);
assert.equal(offer.payloadReport.payload.summary.actorCount, 6);
assert.equal(offer.payloadReport.payload.summary.possessionEventCount, 3);
...
assert.equal(cliReport.offers[0].payloadReport.payload.summary.possessionEventCount, 3);
